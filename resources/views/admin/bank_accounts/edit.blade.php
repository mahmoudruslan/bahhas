    ...
    <div class="row">
        <div class="p-5 col-lg-12">
            <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">{{ __('Edit data') }} : {{ $account['name_'. app()->getLocale()] }}</h1>
            </div>
            <form class="user insubmit" method="POST" action="{{ route('admin.bank-accounts.update', $account->id) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <select name="type" class="form-control">
                                <option selected value="{{ $account->type }}">{{ __($account->type) }}</option>
