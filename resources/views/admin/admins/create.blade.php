        ...
        <div class="p-5 col-lg-12">
            ...
            <form class="user insubmit" method="POST" action="{{ route('admin.admins.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                            placeholder="{{ __('First name') }}" name="first_name" value="{{ old('first_name') }}">
                        @error('first_name')
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                            placeholder="{{ __('Last name') }}" name="last_name" value="{{ old('last_name') }}">
                        @error('last_name')
                            <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row">
                    ...
                    <textarea class="form-control form-control-user" placeholder="{{ __('Address') }}" 
                    name="address" style="border-radius: 4px">{{ old('address') }}</textarea>
                    @error('address')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
