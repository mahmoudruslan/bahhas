...
trait HTMLTrait {
    ...
    {
        return '<div role="group" aria-label="Basic example" class="btn-group" style="width: 150px"> <a type="button" href=" ' . route($route,  $id) . '" class="rbtn btn btn-secondary btn-sm"><i class="fas fa-fw fa-edit"></i></a>';
    }
